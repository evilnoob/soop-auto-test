...
public class IPOffenderDetail extends Page{

    public IPOffenderDetail(WebDriver driver) {
        super(driver);
    }
    ...
    public void arrivalPurposeInput(String data) {
        if (!citizenship.getAttribute("value").equals("Россия")) {
            //System.out.println(citizenship.getAttribute("value"));
    ...
    public WebElement INN = InputField.inputFieldFromExtComp(driver, "Нарушитель", "ИНН");
    ...
    public WebElement addRegistrationAddresButton = Button.numberedButtonFromExtComp(driver, "Нарушитель", "5");
    ...
    public void INNInput(String data) throws InterruptedException {
        //Thread.sleep(5000);
        //INN = InputField.inputFieldFromExtComp(driver, "Нарушитель", "ИНН");
        if (INN.getAttribute("value").length()==0) {
            INN.sendKeys(data);
        }
    }
